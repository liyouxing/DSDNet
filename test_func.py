...
def add_common_test_args(parser, dataset_name=None):
    ...
    test_data_dir = './data/Rain100H/test/'
    if dataset_name == "Rain100L":
        test_data_dir = './data/Rain100L/test/'
    elif dataset_name == "SPA":
        test_data_dir = './data/SPA/test/'
    elif dataset_name == "Rain-Haze":
        test_data_dir = './data/Rain_Haze/test/'
...
'functions for testing TLNet and ALNet'
...
def get_test_args_TA(dataset_name):
    ...
    if dataset_name == "Rain100L":
        ...
        pretrained_dir = './log_train/SPA/TA/net_params_best.tar'
    elif dataset_name == "Rain-Haze":
...
def get_test_args_TAH(dataset_name):
    ...
    pretrained_dir = './log_train/Rain100H/TAH/net_params_best.tar'
    if dataset_name == "Rain100L":
        results_dir = './results/Rain100L/TAH/'
        pretrained_dir = './log_train/Rain100L/TAH/net_params_best.tar'
    elif dataset_name == "SPA":
        results_dir = './results/SPA/TAH/'
        pretrained_dir = './log_train/SPA/TAH/net_params_best.tar'
    elif dataset_name == "Rain-Haze":
        results_dir = './results/Rain_Haze/TAH/'
        pretrained_dir = './log_train/Rain_Haze/TAH/net_params_best.tar'
